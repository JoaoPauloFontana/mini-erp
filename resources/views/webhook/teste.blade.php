    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('webhook.teste.post') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="pedido_id" class="form-label">ID do Pedido</label>
                                @if ($pedidos->isNotEmpty())
                                    <select class="form-select @error('pedido_id') is-invalid @enderror" id="pedido_id"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status"
                                    ...
                                    <option value="confirmado" {{ old('status') == 'confirmado' ? 'selected' : '' }}>
                                        Confirmado</option>
                                    <option value="enviado" {{ old('status') == 'enviado' ? 'selected' : '' }}>Enviado
                                    </option>
                                    <option value="entregue" {{ old('status') == 'entregue' ? 'selected' : '' }}>Entregue
                                    </option>
                    ...
                    <div class="card-body">
                        @foreach ($pedidos as $pedido)
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span
                                    class="badge bg-{{ $pedido->status == 'pendente'
                                        ? 'warning'
